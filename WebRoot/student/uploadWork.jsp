...
<script type="text/javascript">
		...
		window.onload = function() {
			var settings = {
				...
				upload_url: '${pageContext.request.contextPath}/student/WorkUtil_uploadWork',
	     ...
	     function uploadStartFile(){
		    	//上传文件前在这设置参数
		    	var workDir = "<%=request.getParameter("workDir") %>";
				var userId = '${sessionScope.user.userId }';
				var studentCourseId = <%=request.getParameter("studentCourseId")%>;
...
<div id="content">
	<form  method="post" enctype="multipart/form-data">
		<div>你只能上传5M以内的文件哦</div>
		<div class="fieldset flash" id="fsUploadProgress">
			<span class="legend">请选择实验作业</span>
		</div>
