	       		...
	       		onExpandRow: function(index,row){
	            	...
	            	$('#teacher_teacherCourse-'+index).datagrid({
	                	...
	                	columns:[[
	                    	...
	                    	{field:'taskName',title:'任务名称',width:60,align:'left'
	                    	},
	                    	{field:'fileNameF',
	                    		title:'实验指导书',width:120,align:'left',
	                        	formatter:function(value,row,index){
	                        		if (value === undefined) {
	                        			value = ' ';
	                        		}
	                    	...
	                    	{field:'workDir',width:60,align:'left',hidden:true},
	                    	{field:'getWork',title:'学生作业',width:60,align:'left',
	                    		formatter:function(value,row,index){
