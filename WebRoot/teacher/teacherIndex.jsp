	...
	<div style="margin:0 auto;width:1024px;min-height:768px;overflow-y:scrooll;">
		...
		<div class="easyui-panel">
			<div id="index-tabs" class="easyui-tabs" data-options="border:false" style="height:508px;padding:2px;">
	    		 ...
	    		 <div title="上机任务" data-options="href:'${pageContext.request.contextPath}/teacher/teacherCourse.jsp'" style="padding:2px;"></div>
	    		 <div title="学习资料" data-options="href:'${pageContext.request.contextPath}/teacher/material.jsp'" style="padding:2px;"></div>
